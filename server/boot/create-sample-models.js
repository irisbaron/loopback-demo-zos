...
module.exports = function(app) {
   ...
   var rewardsAccount = [
     {AccountName: "VegasTrip"},
     {AccountName: "CentralPerkCredits"},
     {AccountName: "HotelsForPaleontologyConference"}
   ];

   //Create Friend Rewards Program Info
   Rewards.create(rewardsAccount[1], function(err, instance) {
   ...
   Rewards.create(rewardsAccount[0], function(err, instance) {
     if (err) return console.log(err);
